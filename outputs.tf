output "mssql_databases_id" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.id if v.id != null && length(v.id) > 0 }
}
output "mssql_databases_auto_pause_delay_in_minutes" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.auto_pause_delay_in_minutes if v.auto_pause_delay_in_minutes != null }
}
output "mssql_databases_collation" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.collation if v.collation != null && length(v.collation) > 0 }
}
output "mssql_databases_create_mode" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.create_mode if v.create_mode != null && length(v.create_mode) > 0 }
}
output "mssql_databases_creation_source_database_id" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.creation_source_database_id if v.creation_source_database_id != null && length(v.creation_source_database_id) > 0 }
}
output "mssql_databases_elastic_pool_id" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.elastic_pool_id if v.elastic_pool_id != null && length(v.elastic_pool_id) > 0 }
}
output "mssql_databases_enclave_type" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.enclave_type if v.enclave_type != null && length(v.enclave_type) > 0 }
}
output "mssql_databases_geo_backup_enabled" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.geo_backup_enabled if v.geo_backup_enabled != null }
}
...
output "mssql_databases_ledger_enabled" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.ledger_enabled if v.ledger_enabled != null }
}
output "mssql_databases_license_type" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.license_type if v.license_type != null && length(v.license_type) > 0 }
}
...
output "mssql_databases_maintenance_configuration_name" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.maintenance_configuration_name if v.maintenance_configuration_name != null && length(v.maintenance_configuration_name) > 0 }
}
output "mssql_databases_max_size_gb" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.max_size_gb if v.max_size_gb != null }
}
output "mssql_databases_min_capacity" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.min_capacity if v.min_capacity != null }
}
output "mssql_databases_name" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.name if v.name != null && length(v.name) > 0 }
}
output "mssql_databases_read_replica_count" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.read_replica_count if v.read_replica_count != null }
}
output "mssql_databases_read_scale" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.read_scale if v.read_scale != null }
}
output "mssql_databases_recover_database_id" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.recover_database_id if v.recover_database_id != null && length(v.recover_database_id) > 0 }
}
output "mssql_databases_recovery_point_id" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.recovery_point_id if v.recovery_point_id != null && length(v.recovery_point_id) > 0 }
}
output "mssql_databases_restore_dropped_database_id" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.restore_dropped_database_id if v.restore_dropped_database_id != null && length(v.restore_dropped_database_id) > 0 }
}
output "mssql_databases_restore_long_term_retention_backup_id" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.restore_long_term_retention_backup_id if v.restore_long_term_retention_backup_id != null && length(v.restore_long_term_retention_backup_id) > 0 }
}
output "mssql_databases_restore_point_in_time" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.restore_point_in_time if v.restore_point_in_time != null && length(v.restore_point_in_time) > 0 }
}
output "mssql_databases_sample_name" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.sample_name if v.sample_name != null && length(v.sample_name) > 0 }
}
output "mssql_databases_secondary_type" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.secondary_type if v.secondary_type != null && length(v.secondary_type) > 0 }
}
output "mssql_databases_server_id" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.server_id if v.server_id != null && length(v.server_id) > 0 }
}
...
output "mssql_databases_sku_name" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.sku_name if v.sku_name != null && length(v.sku_name) > 0 }
}
output "mssql_databases_storage_account_type" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.storage_account_type if v.storage_account_type != null && length(v.storage_account_type) > 0 }
}
output "mssql_databases_tags" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.tags if v.tags != null && length(v.tags) > 0 }
}
...
output "mssql_databases_transparent_data_encryption_enabled" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.transparent_data_encryption_enabled if v.transparent_data_encryption_enabled != null }
}
output "mssql_databases_transparent_data_encryption_key_automatic_rotation_enabled" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.transparent_data_encryption_key_automatic_rotation_enabled if v.transparent_data_encryption_key_automatic_rotation_enabled != null }
}
output "mssql_databases_transparent_data_encryption_key_vault_key_id" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.transparent_data_encryption_key_vault_key_id if v.transparent_data_encryption_key_vault_key_id != null && length(v.transparent_data_encryption_key_vault_key_id) > 0 }
}
output "mssql_databases_zone_redundant" {
  ...
  value       = { for k, v in azurerm_mssql_database.mssql_databases : k => v.zone_redundant if v.zone_redundant != null }
}
